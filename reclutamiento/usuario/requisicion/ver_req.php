...
<body>
    ...
    <?php
        ...
        $con=mysqli_connect($host,$user,$pass,$name);
            ...
            while($row = mysqli_fetch_array($result)){
                echo "  <tr>\n";
                echo "      <th>".$row[1]."</th>\n";
                echo "      <th><a href = \"ver_req.php?id=".$row[0]."\">Editar</a></th>\n";
    ...
    <?php
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                echo "  <tr>\n";
                echo "      <th><a href = \"ver_req_enproceso.php?id=$idReq\" > ".$row[1]."</a> </th>\n";
                echo "      <th> <a href= \"aprovarpaso.php?idPaso=$pasoID&idPermiso=$paso_permisoID\">$nombrePaso(Aprovar)</a> </th>";
                echo "      <th><a href = \"editar_req.php?id=".$row[0]."\">Editar</a></th>\n";
                echo "      <th><a href = \"borrar_req.php?id=".$row[0]."\">Eliminar</a></th>\n";
                echo "  </tr>";
            }
