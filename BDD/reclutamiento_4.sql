...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-01-2019 a las 14:54:41
...
--
ALTER TABLE `bonos`
  MODIFY `id` int(75) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `calificaciones`
--
ALTER TABLE `calificaciones`
  MODIFY `id` int(75) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `contratos`
  MODIFY `contratoid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `employees`
  MODIFY `employid` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1006;
...
--
ALTER TABLE `entrevista`
  MODIFY `id_entrevista` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `works`
  MODIFY `IDWork` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
